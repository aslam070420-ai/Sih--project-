"""Termux diagnostic for FarmDirect FINAL V15 multi-source mandi sync."""
import market_sync

print("FarmDirect FINAL V15 multi-source market sync")
print("Chain: e-NAM -> AGMARKNET 2.0 -> Tamil Nadu AgriMarket -> data.gov.in -> cache")
